...
const STATIC_META: Record<string, PageMeta> = {
  ...
  '/tools/bear-rally-tier-list/about': {
...
const SUPPORTED_LANGS = ['en', 'es', 'fr', 'zh', 'de', 'ko', 'ja', 'ar', 'tr', 'id', 'ru', 'pt'];
