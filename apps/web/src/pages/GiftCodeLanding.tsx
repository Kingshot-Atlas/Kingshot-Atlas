      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: isMobile ? '1rem' : '2rem' }}>
        ...
        <div style={{
          ...
          <p style={{
            ...
            {t('giftCodeLanding.supporterDesc', 'The Gift Code Auto-Redeemer for alt accounts is included with Atlas Supporter — along with the Battle Planner, unlimited /multirally, and more. Starting at $4.99/month.')}
          </p>
          <div style={{
            display: 'flex', flexDirection: isMobile ? 'column' : 'row',
            gap: '0.75rem', justifyContent: 'center', alignItems: 'center',
