...
const Tools: React.FC = () => {
  ...
  const tools: ToolCardProps[] = [
    ...
    },
    {
      ...
      description: t('tools.battleRegistryDesc', 'Collect player availability and troop levels for KvK Castle Battles. Know who\'s showing up, what they\'re bringing, and plan your castle hit with real data.'),
      tagline: t('tools.battleRegistryTagline', 'Information wins wars.'),
      icon: (
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
