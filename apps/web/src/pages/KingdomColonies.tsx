    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div style={{ textAlign: 'center', padding: '2rem 0' }}>
        <h1 style={{
          ...
          KINGDOM <span style={{ color: '#22d3ee' }}>COLONIES</span>
        </h1>
...
const KingdomColonies: React.FC = () => {
  const { t } = useTranslation();
  ...
  if (!campaign) {
    return (
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '3rem 0', textAlign: 'center' }}>
        ...
        <p style={{ color: '#6b7280' }}>{t('campaign.noCampaignDesc', 'Check back soon for the next Kingdom Colonies campaign!')}</p>
...
export default KingdomColonies;
