  ...
  const features = [
    {
      ...
      desc: 'Players submit their availability and speedups. The system auto-assigns 30-minute buff slots based on who brings the most value. No spreadsheets, no guesswork.',
    },
    {
      icon: '⏱️',
      title: 'Speedup Optimization',
      desc: 'The algorithm prioritizes players with the highest relevant speedups for each day\'s buff type — Construction, Research, or Training. Every minute counts.',
    },
    {
      icon: '📊',
      title: 'One-Click Export',
      desc: 'Export the full 3-day schedule as a spreadsheet. Each day gets its own tab with player names, alliances, slot times, and speedup data. Ready for Discord or in-game chat.',
    },
    {
      icon: '📸',
      title: 'Proof of Speedups',
      desc: 'Players upload a screenshot of their speedup inventory when submitting. Managers can verify claims before assigning slots. Trust, but verify.',
    },
    {
      icon: '🔗',
      title: 'Shareable Form Link',
      desc: 'Share one link with your kingdom. Players see only the submission form — clean, simple, no confusion. They fill it out, you manage the schedule.',
    },
    {
      icon: '⚠️',
      title: 'Smart Conflict Detection',
      desc: 'Unassigned players are flagged instantly. Availability gaps are highlighted. The manager sees exactly where the schedule needs attention — no one gets lost.',
    },
  ];
  ...
  const steps = [
    {
      num: '1',
      icon: '👤',
      title: 'Editor Assigns a Prep Manager',
      desc: 'The kingdom Editor or Co-Editor designates a Prep Manager. This person controls the schedule and assignments.',
    },
    {
      num: '2',
      icon: '📨',
      title: 'Share the Form',
      desc: 'The Prep Manager creates a schedule and shares the form link with kingdom players. Players submit their speedups and availability.',
    },
    {
      num: '3',
      icon: '⚡',
      title: 'Auto-Assign & Export',
      desc: 'One click auto-assigns optimal slots. Review, adjust if needed, then export the schedule and share it with your kingdom.',
    },
  ];
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '700px', margin: '0 auto' }}>
          ...
          <p style={{ color: '#6b7280', fontSize: '0.75rem', marginTop: '0.75rem' }}>
            Available for Prep Managers assigned by Editors or Co-Editors of Gold Tier kingdoms.
          </p>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: isMobile ? '1rem' : '2rem' }}>
        ...
        <div style={{ marginBottom: isMobile ? '2rem' : '3rem' }}>
          ...
          <p style={{
            ...
            Three steps. One organized kingdom.
          </p>
        ...
        <div style={{ marginBottom: isMobile ? '2rem' : '3rem' }}>
          ...
          <p style={{
            ...
            Every feature exists because managing prep phase scheduling was a nightmare. Until now.
          </p>
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            Your kingdom has 200 players. 48 buff slots per day. Do the math.
          </h2>
          <p style={{ color: '#d1d5db', fontSize: isMobile ? '0.85rem' : '0.9rem', lineHeight: 1.7, marginBottom: '1rem' }}>
            Right now, your Prep Manager is probably juggling a Google Sheet, a Discord thread that's 500 messages deep, and a headache. Players post their availability in different time zones. Nobody knows who has the best speedups. Half the slots go to people who don't even show up.
          </p>
          <p style={{ color: '#d1d5db', fontSize: isMobile ? '0.85rem' : '0.9rem', lineHeight: 1.7, marginBottom: '1rem' }}>
            The KvK Prep Scheduler collects everything in one form — speedups, availability, proof screenshots. Then it auto-assigns slots based on who brings the most value for each day's buff type. Construction Monday? The system knows who has the most construction speedups and puts them in the best slots. Research Tuesday? Same logic, different data.
          </p>
          <p style={{ color: '#d1d5db', fontSize: isMobile ? '0.85rem' : '0.9rem', lineHeight: 1.7, marginBottom: '1rem' }}>
            Unassigned players get flagged immediately. Empty time slots are highlighted. The manager sees exactly where the gaps are and can drag-and-drop anyone into any slot with manual override.
          </p>
          <p style={{ color: '#a855f7', fontSize: isMobile ? '0.8rem' : '0.85rem', fontWeight: 600, fontStyle: 'italic' }}>
            That's not scheduling. That's strategic resource allocation.
          </p>
        </div>
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            Who uses the Prep Scheduler?
          </h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem' }}>
              <span style={{ fontSize: '1.1rem', flexShrink: 0 }}>👑</span>
              <div>
                <p style={{ color: '#fff', fontSize: '0.85rem', fontWeight: 600, marginBottom: '0.15rem' }}>Kingdom Editors & Co-Editors</p>
                <p style={{ color: '#9ca3af', fontSize: '0.8rem', lineHeight: 1.5 }}>Create the schedule and assign a trusted Prep Manager. Change or remove the manager at any time.</p>
              </div>
            </div>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem' }}>
              <span style={{ fontSize: '1.1rem', flexShrink: 0 }}>🎯</span>
              <div>
                <p style={{ color: '#fff', fontSize: '0.85rem', fontWeight: 600, marginBottom: '0.15rem' }}>Prep Managers</p>
                <p style={{ color: '#9ca3af', fontSize: '0.8rem', lineHeight: 1.5 }}>Run the schedule. Auto-assign slots, handle edge cases, export the final schedule, and share it with the kingdom. The tool does the heavy lifting.</p>
              </div>
            </div>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem' }}>
              <span style={{ fontSize: '1.1rem', flexShrink: 0 }}>⚔️</span>
              <div>
                <p style={{ color: '#fff', fontSize: '0.85rem', fontWeight: 600, marginBottom: '0.15rem' }}>Kingdom Players</p>
                <p style={{ color: '#9ca3af', fontSize: '0.8rem', lineHeight: 1.5 }}>Click the form link, submit your speedups and availability, upload proof. That's it — your Prep Manager handles the rest.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <h3 style={{
            ...
            Your kingdom deserves organized prep phases.
          </h3>
          <p style={{
            color: '#9ca3af', fontSize: isMobile ? '0.8rem' : '0.85rem',
            marginBottom: '1.25rem', maxWidth: '450px', margin: '0 auto 1.25rem', lineHeight: 1.6,
          }}>
            The KvK Prep Scheduler is available to kingdoms with Gold Tier status through the Kingdom Fund. If your kingdom isn't Gold Tier yet, encourage your alliance leaders to contribute.
          </p>
          <div style={{
            display: 'flex', flexDirection: isMobile ? 'column' : 'row',
            gap: '0.75rem', justifyContent: 'center', alignItems: 'center',
