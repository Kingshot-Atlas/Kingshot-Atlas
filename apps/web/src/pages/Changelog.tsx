...
const Changelog: React.FC = () => {
  ...
  const getCategoryLabel = (category: string) => {
    switch (category) {
      case 'new': return t('changelog.new', 'New');
      case 'fixed': return t('changelog.fixed', 'Fixed');
      case 'improved': return t('changelog.improved', 'Improved');
      default: return t('changelog.changes', 'Changes');
    }
  };
      ...
      <div style={{ 
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '800px', margin: '0 auto' }}>
          ...
          <p style={{ color: '#6b7280', fontSize: isMobile ? '0.8rem' : '0.9rem', marginBottom: '0.75rem' }}>
            {t('changelog.heroSubtitle', "Track every update. Know what's new. Stay ahead.")}
          </p>
          {!isMobile && (
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: isMobile ? '1.5rem 1rem' : '2rem' }}>
        ...
        <div style={{ 
          ...
          <h3 style={{ 
            ...
            {t('changelog.getUpdatesFirst', 'Get Updates First')}
          </h3>
          <p style={{ 
            color: '#9ca3af', 
            ...
            {t('changelog.joinDiscordDesc', 'Join our Discord to get patch notes delivered automatically.')}
          </p>
          <a
