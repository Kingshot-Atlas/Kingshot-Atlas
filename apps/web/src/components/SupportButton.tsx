    ...
    return (
      <a
        ...
        style={{
          ...
          backgroundColor: isHovered ? '#FF5E5B' : '#FF5E5B20',
          border: '1px solid #FF5E5B50',
          borderRadius: '8px',
          color: isHovered ? '#fff' : '#FF5E5B',
          textDecoration: 'none',
          fontSize: '0.85rem',
          fontWeight: '500',
          transition: 'all 0.2s'
  ...
  return (
    <a
      ...
      style={{
        ...
        boxShadow: isHovered ? '0 4px 20px rgba(255, 94, 91, 0.4)' : '0 4px 15px rgba(255, 94, 91, 0.3)',
