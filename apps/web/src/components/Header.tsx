          ...
          >
            <Link
              ...
              style={{
                ...
                textDecoration: 'none',
                fontSize: '0.9rem',
                fontWeight: (isActive('/tools') || isActive('/compare') || isActive('/atlas-bot')) ? '600' : '400',
                transition: 'color 0.2s',
                display: 'flex',
                alignItems: 'center',
                gap: '0.25rem',
                ...((isActive('/tools') || isActive('/compare') || isActive('/atlas-bot')) ? neonGlow('#22d3ee') : {})
              }}
            >
              Tools
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ opacity: 0.6 }}>
              ...
              <div style={{
                ...
                <Link
                  ...
                  style={{
                    ...
                    padding: '0.75rem 1rem',
                    borderRadius: '8px',
                    color: isActive('/transfer-hub') ? '#22d3ee' : '#fff',
                    textDecoration: 'none',
                    fontSize: '0.85rem',
                    transition: 'background-color 0.2s'
                  }}
          ...
          {showMobileToolsMenu && (
            <>
              <Link
                to="/atlas-bot"
                style={{
                  color: isActive('/atlas-bot') ? '#22d3ee' : '#6b7280',
                  textDecoration: 'none',
                  fontSize: '0.9rem',
                  padding: '0.5rem 1rem 0.5rem 1.5rem',
                  borderRadius: '8px',
              ...
              >
                <span style={{ color: '#333' }}>└</span> Atlas Discord Bot
              </Link>
              <Link
                to="/compare"
                style={{
          ...
          {showMobileCommunityMenu && (
            <>
              <Link
                to="/transfer-hub"
                style={{
                  color: isActive('/transfer-hub') ? '#22d3ee' : '#6b7280',
                  textDecoration: 'none',
                  fontSize: '0.9rem',
                  padding: '0.5rem 1rem 0.5rem 1.5rem',
                  borderRadius: '8px',
              ...
              >
                <span style={{ color: '#333' }}>└</span> Transfer Hub
              </Link>
              <Link
                to="/players"
                style={{
