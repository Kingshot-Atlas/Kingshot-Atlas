  ...
  return (
    ...
    <div style={{
      ...
      <button
        ...
        style={{
          color: (isActive('/tools') || isActive('/compare') || isActive('/atlas-bot') || isActive('/transfer-hub') || isActive('/transfer-hub/about') || isActive('/tools/prep-scheduler') || isActive('/tools/prep-scheduler-info') || isActive('/tools/base-designer')) ? '#22d3ee' : '#9ca3af',
          textDecoration: 'none',
          fontSize: '1rem',
          padding: '0.75rem 1rem',
          borderRadius: '8px',
          backgroundColor: (isActive('/tools') || isActive('/compare') || isActive('/atlas-bot') || isActive('/transfer-hub') || isActive('/transfer-hub/about') || isActive('/tools/prep-scheduler') || isActive('/tools/prep-scheduler-info') || isActive('/tools/base-designer')) ? '#111' : 'transparent',
          border: 'none',
          width: '100%',
          textAlign: 'left',
          cursor: 'pointer',
        ...
        <>
          ...
          {expandedToolCategory === 'kingdom' && (
            <>
              ...
              <Link to="/tools/battle-tier-list/about" style={{ color: (isActive('/tools/battle-tier-list') || isActive('/tools/battle-tier-list/about')) ? '#22d3ee' : '#6b7280', textDecoration: 'none', fontSize: '0.85rem', padding: '0.4rem 1rem 0.4rem 2.25rem', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <span style={{ color: '#f97316', fontSize: '0.7rem' }}>●</span> {t('nav.kvkBattleTierList', 'KvK Battle Tier List')}
              </Link>
      ...
      {/* KvK Spreadsheet for trusted submitters */}
      {isTrusted && !isAdmin && (
        <Link
