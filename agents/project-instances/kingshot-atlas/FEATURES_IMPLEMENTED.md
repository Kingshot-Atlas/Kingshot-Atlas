...
| Admin Access Viewer | ✅ Live | Product | `AccessViewerTab.tsx` — Operations tab to look up all assigned roles by kingdom number or username. Queries kingdom_editors, battle_registry_managers, prep_schedule_managers, battle_managers, tool_access, tool_delegates, alliance_managers in parallel. Grouped results with expand/collapse. (2026-03-09) |
